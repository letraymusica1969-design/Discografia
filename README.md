...
Box set **«Canciones de una ciudad»** — un box set de seis discos en vinilo, 80 canciones, del autor **San Cougar** (música y letra).
...
- **Box set:** 6 discos (VOL.01–06): Medianoche, Ciudad de Neon, Ochentas, Llamas, Euforia, Directo. 80 temas en total. Calibrados por BPM, de la balada nocturna a la euforia.
